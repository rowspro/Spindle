...
public static class Settings
{
    ...
    public static SpindleConfig Load()
    {
        try
        {
            if (File.Exists(FilePath))
            {
                ...
                var cfg = JsonSerializer.Deserialize<SpindleConfig>(json);
    ...
    public static void Save(SpindleConfig config)
    {
        try
        {
